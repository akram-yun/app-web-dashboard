...
import png from './../../../assets/images/popurbain11.png';
...
const TotalIncomeDarkCard = ({ isLoading, percentUrbain, nbrUrbain, selectedRegionForApi }) => {
                            ...
                            <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                                ...
                                <ListItemText>
                                    <Typography variant="subtitle2" sx={{ color: 'primary.light', mt: -2 }}>
                                        Taux Population Urbain
                                    </Typography>
                                    <Typography variant="h3" sx={{ color: '#fff', mt: 0.2 }}>
                                        {nbrUrbain.toLocaleString('en-US')}
                                    </Typography>
