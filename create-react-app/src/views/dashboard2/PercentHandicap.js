...
import png from './../../assets/images/Handicap.png';
...
const TotalIncomeDarkCard = ({ isLoading, tauxHandicap, nbrHandicap }) => {
                            ...
                            <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                                ...
                                <ListItemText>
                                    <Typography variant="subtitle2" sx={{ color: 'primary.light', mt: -2 }}>
                                        Taux Des Personnes Handicapés
                                    </Typography>
                                    <Typography variant="h3" sx={{ color: '#fff', mt: 0.3 }}>
                                        {nbrHandicap.toLocaleString('en-US')}
                                    </Typography>
