...
import png from './../../assets/images/analphabetisme.png';
...
const TotalIncomeDarkCard = ({ isLoading, tauxAnalphabetisme, nbrAnalphabetisme }) => {
                            ...
                            <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                                ...
                                <ListItemText>
                                    ...
                                    <Typography variant="h3" sx={{ color: '#fff', mt: 0.3 }}>
                                        {nbrAnalphabetisme.toLocaleString('en-US')}
                                    </Typography>
