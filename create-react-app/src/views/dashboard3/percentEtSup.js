...
import png from './../../assets/images/etudeSup.png';
...
const TotalIncomeDarkCard = ({ isLoading, tauxEtudeSuperieur, nbrEtudeSuperieur }) => {
                            ...
                            <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                                ...
                                <ListItemText>
                                    <Typography variant="subtitle2" sx={{ color: theme.palette.grey[500], mt: -2 }}>
                                        Taux de personnes ayant un diplôme
                                    </Typography>
                                    <Typography variant="h3" sx={{ color: '#000', mt: 0.3 }}>
                                        {nbrEtudeSuperieur.toLocaleString('en-US')}
                                    </Typography>
