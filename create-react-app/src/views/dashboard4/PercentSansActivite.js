...
import png from './../../assets/images/non-travail.png';
...
const TotalIncomeDarkCard = ({ isLoading, tauxSansActivite, nbrSansActivite }) => {
                            ...
                            <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                                ...
                                <ListItemText>
                                    <Typography variant="subtitle2" sx={{ color: theme.palette.grey[500], mt: -2 }}>
                                        Taux de personne d'activités non déclaré
                                    </Typography>
                                    <Typography variant="h3" sx={{ color: '#000', mt: 0.3 }}>
                                        {nbrSansActivite.toLocaleString('en-US')}
                                    </Typography>
